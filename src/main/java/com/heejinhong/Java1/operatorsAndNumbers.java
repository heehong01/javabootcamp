...
public class operatorsAndNumbers {
    public static void main(String[] args){
      ...
      binaryToString(17);
      binaryToString(88);
      binaryWithRightShift(225);
      binaryWithRightShift(1555);
      binaryWithRightShift(32456);
      bitwiseAndOperation();
      incrementoperator();
      threeWaysToIncrementByOne();
      sumWithPostFix();
    }
    ...
    */
    ...
    17
    88 */
    public static void binaryToString(int x){
    ...
    1555
    32456*/
    public static void binaryWithRightShift(int x){
        System.out.println(Integer.toBinaryString(x));
        x = x >> 2;
        System.out.println("New value of x is: " + x);
        System.out.println("Binary value of new x is: " + Integer.toBinaryString(x));
    ...
    */
    public static void bitwiseAndOperation(){
        int x = 7;
        int y = 17;
        int z;
        z = x & y;
    ...
    */
    public static void threeWaysToIncrementByOne(){
    ...
    */
    public static void sumWithPostFix(){
        int x = 5;
        int y = 8;
        int z = ++x + y;
        System.out.println(z);
